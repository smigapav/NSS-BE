package cz.cvut.fel.ear.reservation_system.rest.util;
...
public class RestUtils {
    ...
    /**
     * Creates HTTP headers object with a location header with the specified path
    ...
    public static HttpHeaders createLocationHeaderFromCurrentUri(String path, Object... uriVariableValues) {
        ...
        final URI location = ServletUriComponentsBuilder.fromCurrentRequestUri().path(path)
